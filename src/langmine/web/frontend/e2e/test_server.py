...
# Create a tiny valid JPEG for the screenshot test fixture.
# A minimal 1x1 white JPEG so the screenshot endpoint serves a real file.
_SCREENSHOT_PATH = os.path.join(tempfile.gettempdir(), "e2e_test_screenshot.jpg")
with open(_SCREENSHOT_PATH, "wb") as f:
    ...
    f.write(bytes([
        ...
        0x3F, 0x00, 0x7B, 0x94, 0x11, 0x00, 0xFF, 0xD9,
    ]))
