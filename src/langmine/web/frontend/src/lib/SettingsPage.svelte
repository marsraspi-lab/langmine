		...
		<section class="settings-section">
			...
			<label>
				...
				<select name="translation_api">
					<option value="google" selected={app.config.translation_api === 'google'}
		...
		<section class="settings-section">
			...
			<label>
				...
				<input
					...
					type="number"
					value={app.config.sentence_gap_ms ?? 500}
					min="0"
					max="5000"
				/>
			</label>
			<label>
				Audio Pad Before (ms)
				<input
					name="audio_pad_before_ms"
					type="number"
					value={app.config.audio_pad_before_ms ?? 250}
					min="0"
					max="2000"
				/>
			</label>
			<label>
				Audio Pad After (ms)
				<input
					name="audio_pad_after_ms"
					type="number"
					value={app.config.audio_pad_after_ms ?? 300}
					min="0"
					max="2000"
				/>
			</label>
			<label>
				Max Cards Per Video
				<input
					name="max_cards_per_video"
					type="number"
					value={app.config.max_cards_per_video ?? 20}
					min="1"
					max="100"
				/>
			</label>
			<label>
				Max Stash Cards
				<input
					name="max_stash_cards"
					type="number"
					value={app.config.max_stash_cards ?? 20}
					min="1"
					max="100"
				/>
			</label>
