...
<div class="app-layout">
	<header class="top-bar">
		...
		<div class="top-actions">
			<button
				class="nav-btn"
				class:active={app.currentView === 'curation'}
				onclick={() => (app.currentView = 'curation')}
			>
				📹 Curation
			</button>
			<button
				class="nav-btn"
				class:active={app.currentView === 'settings'}
				onclick={() => (app.currentView = 'settings')}
			>
				⚙️ Settings
			</button>
			<button
				class="nav-btn"
				class:active={app.currentView === 'vocab'}
				onclick={() => (app.currentView = 'vocab')}
			>
				📚 Vocabulary
			</button>
